...
void RadioIrqProcess( void )
{
    ...
    if( isIrqFired == true )
    {
        ...
        if( ( irqRegs & IRQ_TX_DONE ) == IRQ_TX_DONE )
        {
            ...
            // The calls to the ODR module below doesn't follow the convention used elsewhere in this file
            // rather happens before the TX_DONE callback is completed, as this gives a more accurate
            // representation of the power trace
