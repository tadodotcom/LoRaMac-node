...
#ifdef __ZEPHYR__ 
#define FRAG_MAX_NB \
    (CONFIG_LORAWAN_FUOTA_IMAGE_SIZE / CONFIG_LORAWAN_FUOTA_MIN_FRAG_SIZE + 1)
#else
 ...
 */
#ifdef __ZEPHYR__ 
#define FRAG_MAX_SIZE CONFIG_LORAWAN_FUOTA_MAX_FRAG_SIZE
#else
...
#define FRAG_MAX_REDUNDANCY \
    (FRAG_MAX_NB * CONFIG_LORAWAN_FUOTA_FRAG_REDUNDANCY / 100)
#else
